...
begin
  ...
  Dmlistha.ADO_mohasebe_kol_dar_kharid.Open;
    ...
    Frm_print_foroshandegan_jens.QRLarshiv.Caption:=' ÇÒ ÊÇÑíÎ '+tarikh1+' ÊÇ ÊÇÑíÎ '+tarikh2;
end;
...
begin
  ...
  Dmlistha.ADO_mohasebe_kol_dar_kharid.Open;
   Frm_print_foroshandegan_jens.QRLarshiv.Caption:=' ÈÑ ÇÓÇÓ ÊÇÑíÎ'+tarikh;
end;
...
begin
  ...
  Dmlistha.ADO_mohasebe_kol_dar_kharid.Open;
   Frm_print_foroshandegan_jens.QRLarshiv.Caption:=' ÈÑ ÇÓÇÓ ÓÇá '+scsal.Text;
end;
