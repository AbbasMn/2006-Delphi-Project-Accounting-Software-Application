...
///////////////////////////////////////////////////////////////////////////////////////////////////
       ...
       if DataModule1.ADOQuery3.RecordCount<=0 then
        begin
          ...
          begin
            suiEdit1.SetFocus;
            st:=pchar('«‰ÃÌ—” «‰ << '+suiEdit2.Text+'>> –ŒÌ—Â ‘œ');
          end;
          ...
          begin
            if noe='shakhs' then
              st:=pchar(' «‰ÃÌ—” «‰ << '+suiEdit2.Text+'>> „ÊÃÊœ „Ì »«‘œ.');
      ...
      begin
        if noe='shakhs' then
          MessageBox(Handle,'òœ «‰ÃÌ—” «‰°‰«„ Ê   ⁄œ«œ  œ—Œ  »«Ìœ Ê«—œ ‘Ê‰œ. ','Œÿ« !',MB_OK or MB_ICONEXCLAMATION or MB_RTLREADING or MB_RIGHT)
...
begin
  ...
  begin
      ...
      begin
        if noe='shakhs' then
          MessageBox(Handle,'òœ «‰ÃÌ—” «‰° ‰«„ «‰ÃÌ—” «‰ »«Ìœ Ê«—œ ‘Ê‰œ. ','Œÿ« !',MB_OK or MB_ICONEXCLAMATION or MB_RTLREADING or MB_RIGHT);
...
begin
  MessageBox(Handle,'«‰ÃÌ—” «‰  ÃœÌœÌ «÷«›Â ‰‘œ',' ÊÃÂ! ',MB_OK or MB_ICONINFORMATION or MB_RTLREADING or MB_RIGHT );
  clear;
end;
