object frm_eslahe_kharid_checkha: Tfrm_eslahe_kharid_checkha
  Left = 147
  Top = 76
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = #1575#1589#1604#1575#1581' '#1605#1576#1604#1594' '#1662#1585#1583#1575#1582#1578#1610' '#1670#1705' '#1576#1585#1575#1610' '#1588#1605#1575#1585#1607' '#1601#1575#1705#1578#1608#1585
  ClientHeight = 567
  ClientWidth = 369
  Color = clBtnFace
  ...
  object DataSource5: TDataSource
    DataSet = DataM_final.ADOQ_t_Temp_pardakht_check_kharid
    Left = 123
    Top = 390
  end
