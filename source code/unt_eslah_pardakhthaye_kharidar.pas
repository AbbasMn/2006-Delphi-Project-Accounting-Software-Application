...
//////////////////////////////////////////////////////
   ...
   QuotedStr(tarikh)+',mablag='+E_mablagh.Text+',tozih=tozih+'+QuotedStr(' „»·€ œ—Ì«› Ì «’·«Õ ê—œÌœ „»·€ ﬁ»·Ì Å—œ«Œ  = '+L_mablagh.Caption)+
   ' where cod_kharidar='+DataModule1.ADOQuery3code.AsString+
   ' and tarikh='+
   QuotedStr(tarikh_g)+' and tozih='+QuotedStr('œ—Ì«›  ‰ﬁœÌ œ— Å—œ«Œ  »œÂÌ  Ê”ÿ '+trim(DataModule1.ADOQuery3shahrforoshande.AsString))+
...
///////////////////////////////////////////////////////////////////////
      frm_main.l_last_op.Caption:=' «’·«Õ Å—œ«Œ  »œÂÌ  Ê”ÿ '+DataModule1.ADOQuery3shahrforoshande.AsString+' À»  ‘œÂ œ—  «—ÌŒ '+DataModule1.ADOpardakhtbedehi_kharidartarikh.AsString;
       ...
       datam_sp_eslahe_forosh.ADOStoredProc_eslahe_pardakhte_bedehi_tavasote_moshtar.Parameters[11].Value:=' œ—Ì«›  ‰ﬁœÌ œ— Å—œ«Œ  »œÂÌ  Ê”ÿ '+DataModule1.ADOQuery3shahrforoshande.AsString+' „»·€ ﬁ»· = '+DataModule1.ADOpardakhtbedehi_kharidarmablagh.AsString;//@tozih_sandog nvarchar(150),
       datam_sp_eslahe_forosh.ADOStoredProc_eslahe_pardakhte_bedehi_tavasote_moshtar.Parameters[12].Value:=b_j;//@b_j float,

       datam_sp_eslahe_forosh.ADOStoredProc_eslahe_pardakhte_bedehi_tavasote_moshtar.Parameters[13].Value:=' «’·«Õ Å—œ«Œ  »œÂÌ  Ê”ÿ '+DataModule1.ADOQuery3shahrforoshande.AsString+
       ' «“ „»·€ '+L_mablagh.Caption+' »Â „»·€ '+
       E_mablagh.Text+'»Â '+' «“  «—ÌŒ '+

       DataModule1.ADOpardakhtbedehi_kharidartarikh.AsString+'»Â  «—ÌŒ '+e_t_sal.Text+'/'+e_t_mah.Text+'/'+e_t_roz.Text;//@amaliat nvarchar(1000)
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        pch:=pchar(' »Â œ·Ì· «Ì‰òÂ „»·€ »œÂÌ «“ ﬁ»· «Ê·Ì‰ ›«ò Ê— ›—Ê‘ œ—  «—ÌŒ «‰ Œ«»Ì Å—œ«Œ  Ê ”«⁄  ¬‰ = '+DataM_final.ADOQ_takhfife_forosh2bedehi_az_gabl.AsString+' ò„ — «“ „»·€ «÷«›Â ‘œÂ »Â Å—œ«Œ  = '+FloatToStr(b_j)+' „Ì »«‘œ ‰„Ì  Ê«‰Ìœ Å—œ«Œ  —« »«  «—ÌŒ «‰ Œ«»Ì ÊÌ—«Ì‘ ‰„«ÌÌœ');
...
begin
  ...
  begin
    max_bedehi:=false;
    mb:=pchar('„»·€ Ê«—œ ‘œÂ »«Ìœ ò„ — «“ »œÂÌ ò· ‘Œ’ << '+FloatToStr(bedeh+feli)+' >> »«‘œ ');
...
begin
   ...
   DataModule_gozaresh_tarkibi.ADOQuery_daryaft_be_sandog.SQL.Text:='update T_vorod_khoroj_sandogha set tarikh='+
   QuotedStr(tarikh_j)+',mablag='+E_mablagh.Text+',tozih=tozih+'+QuotedStr(' „»·€ œ—Ì«› Ì «’·«Õ ê—œÌœ „»·€ ﬁ»·Ì Å—œ«Œ  = '+L_mablagh.Caption)+
   ' where cod_kharidar='+DataModule1.ADOQuery3code.AsString+
   ' and tarikh='+
   QuotedStr(tarikh_g)+' and tozih='+QuotedStr('œ—Ì«›  ‰ﬁœÌ œ— Å—œ«Œ  »œÂÌ  Ê”ÿ '+trim(DataModule1.ADOQuery3shahrforoshande.AsString))+
   ' and mablag='+L_mablagh.Caption+' and time_='+QuotedStr(l_time.Caption);
  ...
  begin
    ...
    begin//////
      ...
      if mablag<DataModule1.ADOpardakhtbedehi_kharidarmablagh.AsFloat then
        ...
        begin
          MessageBox(Handle,pchar('„»·€Ì òÂ «“ Å—œ«Œ  »œÂÌ ›⁄·Ì ò„ „Ì ‘Êœ «“ „ÊÃÊœÌ ’‰œÊﬁÌ òÂ »œÂÌ »Â ¬‰ Ê«—œ ‘œÂ «”   << '+sandog+' >> = << '+FloatToStr(mojodi)+' >> »Ì‘ — „Ì »«‘œ.'),'Œÿ«! ',MB_OK or MB_ICONEXCLAMATION or MB_RTLREADING or MB_RIGHT );
          Exit;
        end;
      ...
      {frm_main.l_last_op.Caption:=' «’·«Õ Å—œ«Œ  »œÂÌ  Ê”ÿ '+DataModule1.ADOQuery3shahrforoshande.AsString+' À»  ‘œÂ œ—  «—ÌŒ '+DataModule1.ADOpardakhtbedehi_kharidartarikh.AsString;
       ...
       frm_main.sabte_amaliat(' «’·«Õ Å—œ«Œ  »œÂÌ  Ê”ÿ '+DataModule1.ADOQuery3shahrforoshande.AsString+
       ' «“ „»·€ '+L_mablagh.Caption+' »Â „»·€ '+
       E_mablagh.Text+'»Â '+' «“  «—ÌŒ '+

       DataModule1.ADOpardakhtbedehi_kharidartarikh.AsString+'»Â  «—ÌŒ '+e_t_sal.Text+'/'+e_t_mah.Text+'/'+e_t_roz.Text);
