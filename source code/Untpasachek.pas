...
begin
  ...
  begin
    DataModule2.adochek.SQL.Text:='update forosh_jens set chek_pas="Å«” ‘œÂ" where chek_number='+QuotedStr(DBLookupComboBox1.Text);
    DataModule2.adochek.ExecSQL;
    MessageBox(Handle,'çò »« ‘„«—Â «‰ Œ«» ‘œÂ Å«” ‘œ',' ÊÃÂ',MB_OK  or MB_ICONINFORMATION or MB_RTLREADING or MB_RIGHT);
  end
 else
    MessageBox(Handle,'‘„«—Â çò —« «‰ Œ«» ‰„«ÌÌœ',' Œÿ« !',MB_OK  or MB_ICONERROR or MB_RTLREADING or MB_RIGHT);
end;
