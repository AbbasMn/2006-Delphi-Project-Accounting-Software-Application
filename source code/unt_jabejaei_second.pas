...
begin
   ...
   //////////// khoroji //////////////
    ...
    QuotedStr(' Ã«»Â Ã«ÌÌ Ã‰” «“ „ò«‰ '+Dmanbarexite.ADOanbarnamename.AsString+' »Â „ò«‰ '+Dmanbarexite.ADOanbarname2name.AsString+' Ê À»  »« òœ ÃœÌœ '+cod)+','+
...
begin
   ...
   //////////// khoroji //////////////
    ...
    QuotedStr(' Ã«»Â Ã«ÌÌ Ã‰” «“ „ò«‰ '+Dmanbarexite.ADOanbarnamename.AsString+' »Â „ò«‰ '+Dmanbarexite.ADOanbarname2name.AsString+' Ê À»  »« òœ ﬁ»·Ì Ã‰” '+cod)+','+
    QuotedStr(frm_main.L_tarikh.Caption)+','+
    QuotedStr(Dmlistha.ADOlistanbarforoshbarcod.AsString)+','+
    QuotedStr(Dmlistha.ADOlistanbarforoshcode_sherkati.AsString)+','+
...
begin
   ...
   //////////// khoroji //////////////
    ...
    QuotedStr(' Ã«»Â Ã«ÌÌ Ã‰” «“ „ò«‰ '+Dmanbarexite.ADOanbarnamename.AsString+' »Â „ò«‰ '+Dmanbarexite.ADOanbarname2name.AsString+' Ê «÷«›Â ‘œ‰  ⁄œ«œ Ã‰” »Â  ⁄œ«œ Ã‰” „ÊÃÊœ «“ ﬁ»· Ê À»  »« òœ ﬁ»·Ì Ã‰” '+cod)+','+
    QuotedStr(frm_main.L_tarikh.Caption)+','+
    QuotedStr(Dmlistha.ADOlistanbarforoshbarcod.AsString)+','+
    QuotedStr(Dmlistha.ADOlistanbarforoshcode_sherkati.AsString)+','+
...
begin
     ...
     s:=pchar('Ã‰” «‰ Œ«»Ì »«  ÊÃÂ »Â òœ Ã‰”°œ— „ò«‰ „ﬁ’œ ÊÃÊœ œ«—œ°  ⁄œ«œ Ã‰” Ã«»Â Ã« ‘œÂ »Â  ⁄œ«œ „ÊÃÊœ œ— „ò«‰ „ﬁ’œ «÷«›Â ê—œœø');
        if MessageBox(Handle,s,' ÊÃÂ !',MB_YESNO or MB_ICONQUESTION or MB_RTLREADING or MB_RIGHT)=id_yes then
        begin

          tozihe_forosh:='Ã‰” œ—  «—ÌŒ '+frm_main.L_tarikh.Caption+' »Â «‰œ«“Â ' +l_tedad_koli_jabejaei.Caption+' Ê«Õœ ò·Ì Ê »Â  ⁄œ«œ '+
          l_tedad_jozi_jabejaei.Caption+' Ê«Õœ Ã“∆Ì '+' „⁄«œ· »«  ⁄œ«œ ò· '+l_tedad_kole_jabejaei.Caption+' «“ „ò«‰ '+Dmanbarexite.ADOanbarnamename.AsString+' »Â «Ì‰ „ò«‰ Ã«»Â Ã« ‘œ Ê  ⁄œ«œ Ã‰” Ã«»Â Ã« ‘œÂ »Â  ⁄œ«œ „ÊÃÊœÌ ›⁄·Ì Ã‰”  »« òœ Ã‰” ›⁄·Ì «÷«›Â ê—œÌœ';
 ...
 //////////////////////////////////////////////////////////////////////////////////////////////////////////////
          ...
          frm_main.l_last_op.Caption:=' Ã«»Â Ã«ÌÌ Ã‰” '+DBText_name.Caption+' »Â  ⁄œ«œ ò·Ì '+l_tedad_koli_jabejaei.Caption+' Ê  ⁄œ«œ Ã“∆Ì '+l_tedad_jozi_jabejaei.Caption+
          ' »—«»— »«  ⁄œ«œ ò· '+l_tedad_kole_jabejaei.Caption;
           ...
           DataM_sp.ADOStoredProc_ja_be_jaeie_jens_ezafe_shodan_be_tedad_mojod_ba_c.Parameters[9].Value:=frm_main.l_last_op.Caption+' «“ „ò«‰ '+Dmanbarexite.ADOanbarnamename.AsString+' »Â „ò«‰ '+Dmanbarexite.ADOanbarname2name.AsString+' Ê «÷«›Â ‘œ‰  ⁄œ«œ ò· »Â  ⁄œ«œ „ÊÃÊœ «“ Â„Ì‰ Ã‰” œ— „ò«‰ «‰ Œ«»Ì ';//@amaliat nvarchar(1000)
           ...
           DataM_sp.ADOStoredProc_ja_be_jaeie_jens_ezafe_shodan_be_tedad_mojod_ba_c.Parameters[23].Value:=' Ã«»Â Ã«ÌÌ Ã‰” «“ „ò«‰ '+Dmanbarexite.ADOanbarnamename.AsString+' »Â „ò«‰ '+Dmanbarexite.ADOanbarname2name.AsString+' Ê «÷«›Â ‘œ‰  ⁄œ«œ Ã‰” »Â  ⁄œ«œ Ã‰” „ÊÃÊœ «“ ﬁ»· Ê À»  »« òœ ﬁ»·Ì Ã‰” '+L_code_cala.Caption;//@tozihe_kho_az_anbar nvarchar(200),
           DataM_sp.ADOStoredProc_ja_be_jaeie_jens_ezafe_shodan_be_tedad_mojod_ba_c.Parameters[24].Value:=' Ã«»Â Ã«ÌÌ Ã‰” «“ „ò«‰ '+Dmanbarexite.ADOanbarnamename.AsString+' »Â „ò«‰ '+Dmanbarexite.ADOanbarname2name.AsString+' Ê «÷«›Â ‘œ‰  ⁄œ«œ Ã‰” »Â  ⁄œ«œ Ã‰” „ÊÃÊœ «“ ﬁ»· Ê À»  »« òœ ﬁ»·Ì Ã‰” '+L_code_cala.Caption;//@tozihe_vo_be_anbar nvarchar(200),

           DataM_sp.ADOStoredProc_ja_be_jaeie_jens_ezafe_shodan_be_tedad_mojod_ba_c.Parameters[25].Value:='Œ—ÊÃÌ - Ã«»Ã«ÌÌ';//@type_kh_az_anbar nvarchar(100),
           DataM_sp.ADOStoredProc_ja_be_jaeie_jens_ezafe_shodan_be_tedad_mojod_ba_c.Parameters[26].Value:='Ê—ÊœÌ - Ã«»Ã«ÌÌ';//@type_vo_be_anbar nvarchar(100),
          ...
          MessageBox(Handle,pchar('Ã«»Â Ã«ÌÌ Ã‰” «‰Ã«„ ‘œ'),' ÊÃÂ !',MB_OK or MB_ICONINFORMATION or MB_RIGHT or MB_RTLREADING);           
 ...
 //////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        begin
          s:=pchar('Ã‰” »« òœ ÃœÌœ œ— „ò«‰ „ﬁ’œ –ŒÌ—Â ê—œœø');
          if MessageBox(Handle,s,' ÊÃÂ !',MB_YESNO or MB_ICONQUESTION or MB_RTLREADING or MB_RIGHT)=id_yes then
          begin
            cod_jadid:=FloatToStr(frmaddanbar.akharin_code_cala+1);
            {insert_gozaresh_jabejaei_anbar_sabt_ba_code_jadid(cod_jadid);}
            tozihe_forosh:='Ã‰” œ—  «—ÌŒ '+frm_main.L_tarikh.Caption+' »Â «‰œ«“Â ' +l_tedad_koli_jabejaei.Caption+' Ê«Õœ ò·Ì Ê »Â  ⁄œ«œ '+
            l_tedad_jozi_jabejaei.Caption+' Ê«Õœ Ã“∆Ì '+' „⁄«œ· »«  ⁄œ«œ ò· '+l_tedad_kole_jabejaei.Caption+' «“ „ò«‰ '+Dmanbarexite.ADOanbarnamename.AsString+' »Â «Ì‰ „ò«‰ Ã«»Â Ã« ‘œ Ê »« òœ ÃœÌœ –ŒÌ—Â ê—œÌœ';
 ...
 //////////////////////////////////////////////////////////////////////////////////////////////////////////////
           ...
           DataM_sp.ADOStoredProc_ja_be_jaeie_jens_ezafe_shodane_jense_mojod_ba_cod.Parameters[8].Value:=frm_main.l_last_op.Caption+' «“ „ò«‰ '+Dmanbarexite.ADOanbarnamename.AsString+' »Â „ò«‰ '+Dmanbarexite.ADOanbarname2name.AsString+' Ê –ŒÌ—Â »« òœ ÃœÌœ';//@amaliat nvarchar(1000),
           ...
           DataM_sp.ADOStoredProc_ja_be_jaeie_jens_ezafe_shodane_jense_mojod_ba_cod.Parameters[24].Value:=' Ã«»Â Ã«ÌÌ Ã‰” «“ „ò«‰ '+Dmanbarexite.ADOanbarnamename.AsString+' »Â „ò«‰ '+Dmanbarexite.ADOanbarname2name.AsString+' Ê À»  »« òœ ÃœÌœ '+cod_jadid;//@tozihe_kho_az_anbar nvarchar(200),
           DataM_sp.ADOStoredProc_ja_be_jaeie_jens_ezafe_shodane_jense_mojod_ba_cod.Parameters[25].Value:=' Ã«»Â Ã«ÌÌ Ã‰” «“ „ò«‰ '+Dmanbarexite.ADOanbarnamename.AsString+' »Â „ò«‰ '+Dmanbarexite.ADOanbarname2name.AsString+' Ê À»  »« òœ ÃœÌœ '+cod_jadid;//@tozihe_vo_be_anbar nvarchar(200),

           DataM_sp.ADOStoredProc_ja_be_jaeie_jens_ezafe_shodane_jense_mojod_ba_cod.Parameters[26].Value:='Œ—ÊÃÌ - Ã«»Ã«ÌÌ';//@type_kh_az_anbar nvarchar(100),
           DataM_sp.ADOStoredProc_ja_be_jaeie_jens_ezafe_shodane_jense_mojod_ba_cod.Parameters[27].Value:='Ê—ÊœÌ - Ã«»Ã«ÌÌ';//@type_vo_be_anbar nvarchar(100),
 ...
 //////////////////////////////////////////////////////////////////////////////////////////////////////////////                
           ...
           MessageBox(Handle,pchar('Ã«»Â Ã«ÌÌ Ã‰” «‰Ã«„ ‰‘œ'),' ÊÃÂ !',MB_OK or MB_ICONEXCLAMATION or MB_RIGHT or MB_RTLREADING);
        end;
end;
...
begin
     ...
     tedad_jozi_dar_koli:=StrToFloat(DBText_tedade_jozi_dar_koli.Caption);
      ...
      s:=pchar('Ã‰” «‰ Œ«»Ì »«  ÊÃÂ »Â òœ ¬‰° œ— „ò«‰ „ﬁ’œ ÊÃÊœ ‰œ«—œ ° ¬Ì« Ã‰” œ— „ò«‰ „ﬁ’œ »« òœ ÃœÌœ –ŒÌ—Â ‘Êœø(œ— ’Ê—  Å«”Œ „‰›Ì Ã‰” »« òœ ›⁄·Ì œ— „ò«‰ „ﬁ’œ –ŒÌ—Â „Ì ê—œœ)');
        if MessageBox(Handle,s,' ÊÃÂ !',MB_YESNO or MB_ICONQUESTION or MB_RTLREADING or MB_RIGHT)=id_yes then
        begin ////////1
          cod_jadid:=FloatToStr(frmaddanbar.akharin_code_cala+1);
          {insert_gozaresh_jabejaei_anbar_sabt_ba_code_jadid(cod_jadid); }
 ...
 //////////////////////////////////////////////////////////////////////////////////////////////////////////////
           ...
           DataM_sp.ADOStoredProc_ja_be_jaeie_jens_ba_code_jadid.Parameters[8].Value:=frm_main.l_last_op.Caption+' «“ „ò«‰ '+Dmanbarexite.ADOanbarnamename.AsString+' »Â „ò«‰ '+Dmanbarexite.ADOanbarname2name.AsString;//@amaliat nvarchar(1000),
           ...
           DataM_sp.ADOStoredProc_ja_be_jaeie_jens_ba_code_jadid.Parameters[24].Value:=' Ã«»Â Ã«ÌÌ Ã‰” «“ „ò«‰ '+Dmanbarexite.ADOanbarnamename.AsString+' »Â „ò«‰ '+Dmanbarexite.ADOanbarname2name.AsString+' Ê À»  »« òœ ÃœÌœ '+cod_jadid;//@tozihe_kho_az_anbar nvarchar(200),
           DataM_sp.ADOStoredProc_ja_be_jaeie_jens_ba_code_jadid.Parameters[25].Value:=' Ã«»Â Ã«ÌÌ Ã‰” «“ „ò«‰ '+Dmanbarexite.ADOanbarnamename.AsString+' »Â „ò«‰ '+Dmanbarexite.ADOanbarname2name.AsString+' Ê À»  »« òœ ÃœÌœ '+cod_jadid;//@tozihe_vo_be_anbar nvarchar(200),

           DataM_sp.ADOStoredProc_ja_be_jaeie_jens_ba_code_jadid.Parameters[26].Value:='Œ—ÊÃÌ - Ã«»Ã«ÌÌ';//@type_kh_az_anbar nvarchar(100),
           DataM_sp.ADOStoredProc_ja_be_jaeie_jens_ba_code_jadid.Parameters[27].Value:='Ê—ÊœÌ - Ã«»Ã«ÌÌ';//@type_vo_be_anbar nvarchar(100),
 ...
 //////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        begin////////2
          s:=pchar('Ã‰” Ì« òœ ›⁄·Ì œ— „ò«‰ „ﬁ’œ –ŒÌ—Â ê—œœø');
          if MessageBox(Handle,s,' ÊÃÂ !',MB_YESNO or MB_ICONQUESTION or MB_RTLREADING or MB_RIGHT)=id_yes then
          begin///3
            cod_jadid:=Dmlistha.ADOlistanbarforoshcalacod.AsString;
            {insert_gozaresh_jabejaei_anbar_sabt_ba_code_gabl(cod_jadid);}
            tozihe_forosh:='Ã‰” œ—  «—ÌŒ '+frm_main.L_tarikh.Caption+' »Â «‰œ«“Â ' +l_tedad_koli_jabejaei.Caption+' Ê«Õœ ò·Ì Ê »Â  ⁄œ«œ '+
            l_tedad_jozi_jabejaei.Caption+' Ê«Õœ Ã“∆Ì '+' „⁄«œ· »«  ⁄œ«œ ò· '+l_tedad_kole_jabejaei.Caption+' «“ „ò«‰ '+Dmanbarexite.ADOanbarnamename.AsString+' »Â «Ì‰ „ò«‰ Ã«»Â Ã« ‘œ Ê »« Â„«‰ òœ ﬁ»·Ì „ò«‰ „»œ«¡ –ŒÌ—Â ê—œÌœ';
 ...
 //////////////////////////////////////////////////////////////////////////////////////////////////////////////
           ...
           DataM_sp.ADOStoredProc_ja_be_jaeie_jens_ba_code_feli.Parameters[9].Value:=frm_main.l_last_op.Caption+' «“ „ò«‰ '+Dmanbarexite.ADOanbarnamename.AsString+' »Â „ò«‰ '+Dmanbarexite.ADOanbarname2name.AsString;//@amaliat nvarchar(1000)
           ...
           DataM_sp.ADOStoredProc_ja_be_jaeie_jens_ba_code_feli.Parameters[23].Value:=' Ã«»Â Ã«ÌÌ Ã‰” «“ „ò«‰ '+Dmanbarexite.ADOanbarnamename.AsString+' »Â „ò«‰ '+Dmanbarexite.ADOanbarname2name.AsString+' Ê À»  »« òœ ﬁ»·Ì Ã‰” '+l_code_cala.Caption;//@tozihe_kho_az_anbar nvarchar(200),
           DataM_sp.ADOStoredProc_ja_be_jaeie_jens_ba_code_feli.Parameters[24].Value:=' Ã«»Â Ã«ÌÌ Ã‰” «“ „ò«‰ '+Dmanbarexite.ADOanbarnamename.AsString+' »Â „ò«‰ '+Dmanbarexite.ADOanbarname2name.AsString+' Ê À»  »« òœ ﬁ»·Ì Ã‰” '+l_code_cala.Caption;//@tozihe_vo_be_anbar nvarchar(200),

           DataM_sp.ADOStoredProc_ja_be_jaeie_jens_ba_code_feli.Parameters[25].Value:='Œ—ÊÃÌ - Ã«»Ã«ÌÌ';//@type_kh_az_anbar nvarchar(100),
           DataM_sp.ADOStoredProc_ja_be_jaeie_jens_ba_code_feli.Parameters[26].Value:='Ê—ÊœÌ - Ã«»Ã«ÌÌ';//@type_vo_be_anbar nvarchar(100),
...
begin
  ...
  QuotedStr(Dmanbarexite.ADOanbarnamename.AsString)+' and  name<>'+QuotedStr('«‰»«— „Ã«“Ì')+
...
if Dmanbarexite.ADOanbarname2.RecordCount<>0 then
  frm_ajnase_makane_magsad.ShowModal
    ...
    MessageBox(Handle,pchar('„ò«‰ „ﬁ’œ œ— Ã«»Â Ã«ÌÌ «‰ Œ«» ‰‘œÂ «” '),'Œÿ« !',MB_OK or MB_ICONEXCLAMATION or MB_RIGHT or MB_RTLREADING);
end;
