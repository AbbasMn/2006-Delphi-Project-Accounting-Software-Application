    ...
    begin
      if (Ljensname.Caption='') or (trim(Egeymatjadid.Text)='') then
       ...
       begin
         ...
         st:=pchar(trim(' ﬁÌ„  ›—Ê‘ ò·Ì Ã‰” œ—  «—ÌŒ'+tarikh+' «“ '+' '+Lgeymatghabli.Caption+' '+ ' »Â '+' '+trim(Egeymatjadid.Text)+' '+' €ÌÌ— ÅÌœ«ò—œ'));


         frm_main.l_last_op.Caption:='  €ÌÌ— ﬁÌ„  ›—Ê‘ ò·Ì Ã‰” '+Ljensname.Caption;
    ...
    begin
      ...
      begin
       ...
       if RadioGroup1.ItemIndex=0 then
        ...
        st:=pchar(trim(' ﬁÌ„  ›—Ê‘ ò·Ì '+tarikh+' «“ '+' '+Lgeymatghabli.Caption+ ' »Â '+' '+FloatToStr(geymat)+' '+'  €ÌÌ— ÅÌœ«ò—œ '));
...
procedure Tfrm_vrode_geymate_koli_jadid.EgeymatjadidChange(
  Sender: TObject);
begin
pmolaforforosh.Text:=' ﬁÌ„  ›—Ê‘ ò·Ì Ã‰” œ—  «—ÌŒ'+frm_main.L_tarikh.Caption+' «“ '+' '+Lgeymatghabli.Caption+' '+' »Â '+' '+trim(Egeymatjadid.Text)+' '+' €ÌÌ— ÅÌœ«ò—œ';
end;
...
begin
  if RadioGroup1.ItemIndex=0 then
    pmolaforforosh.Text:=' ﬁÌ„  ›—Ê‘ ò·Ì Ã‰” œ—  «—ÌŒ'+frm_main.L_tarikh.Caption+' '+trim(E_darsad_sod.Text)+' '+'œ—’œ «›“«Ì‘ Ì«› '
  else
    pmolaforforosh.Text:=' ﬁÌ„  ›—Ê‘ ò·Ì Ã‰” œ—  «—ÌŒ'+frm_main.L_tarikh.Caption+' '+trim(E_darsad_sod.Text)+' '+'œ—’œ ò«Â‘ Ì«› ';
end;
