...
begin
 ...
 begin
  ...
  frm_main.l_last_op.Caption:='À»  Ã„⁄ ¬Ê—Ì „Õ’Ê· «“ «‰ÃÌ—” «‰ '+DataModule1.ADOQuery4shahrforoshande.AsString;
  ...
  DataM_sp.ADOStoredProc_kharid.Parameters[9].Value:=frm_main.l_last_op.Caption+' »« ‘„«—Â ›«ò Ê— '+sh_factor;//@amaliat nvarchar(1000)
...
begin
  ...
  begin
    ...
    begin
     check_sh_fac:=false;
     MessageBox(Handle,'‘„«—Â ›«ò Ê— —« Ê«—œ ò‰Ìœ.','Œÿ«! ',MB_OK or MB_ICONEXCLAMATION or MB_RTLREADING or MB_RIGHT );
    ...
    begin
      ...
      begin
        check_sh_fac:=false;
        MessageBox(Handle,'‘„«—Â ›«ò Ê— Ê«—œ ‘œÂ °  ﬁ»·¬ Ê«—œ ‘œÂ «” .','Œÿ«! ',MB_OK or MB_ICONEXCLAMATION or MB_RTLREADING or MB_RIGHT );
      end;
    end;
...
begin
  ...
  if type_='koli' then
   ...
   { Dmlistha.ADOQuery_anbar_majazi.SQL.Text:='insert into T_anbar_majazi(tedad_koli,vahed_koli,geymat_koli,tedad_jozi_da_koli,vahed_jozi,geymat_forosh_koli'+
     ...
     ','+QuotedStr(geymat_jozi)+','+QuotedStr(geymat_jozi)+','+QuotedStr('„Õ’Ê· œ— «‰»«— „Ã«“Ì ﬁ—«— œ«—œ')+','+
...
begin
   ...
   { Dmanbar.ADOQ_gozaresh_anbar.SQL.Text:='insert into T_gozaresh_vorod_va_khoroje_anbar'+
    ...
    QuotedStr(' «÷«›Â ‰„Êœ‰ „Õ’Ê· »Â ›«ò Ê— Œ—Ìœ ‘„«—Â '+DataM_final.ADOQ_t_sh_facrorhaye_kharidshomare.AsString+' ›—Ê‘‰œÂ '+DataM_final.ADOQ_t_sh_facrorhaye_kharidshahrforoshande.AsString)+','+
    ...
    QuotedStr('Ê—ÊœÌ - «÷«›Â ò—œ‰ „Õ’Ê· »Â ›«ò Ê— Œ—Ìœ')+
    ')';

    Dmanbar.ADOQ_gozaresh_anbar.ExecSQL;  }

    ////////////////////////////////////////////////////////////////////////////////////////////////////////
      frm_main.l_last_op.Caption:=' «÷«›Â ò—œ‰ „Õ’Ê· '+jens+' »Â Œ—Ìœ »« ‘„«—Â ›«ò Ê— '+DataM_final.ADOQ_t_sh_facrorhaye_kharidshomare.AsString+
   ...
   datam_sp_eslahe_forosh.ADOStoredProc_eslahe_kharid_ezafe_jens.Parameters[13].Value:=' «÷«›Â ‰„Êœ‰ „Õ’Ê· »Â ›«ò Ê— Œ—Ìœ ‘„«—Â '+DataM_final.ADOQ_t_sh_facrorhaye_kharidshomare.AsString+' ›—Ê‘‰œÂ '+DataM_final.ADOQ_t_sh_facrorhaye_kharidshahrforoshande.AsString;//@tozihe_anbar nvarchar(200),
   ...
   datam_sp_eslahe_forosh.ADOStoredProc_eslahe_kharid_ezafe_jens.Parameters[17].Value:='Ê—ÊœÌ - «÷«›Â ò—œ‰ „Õ’Ê· »Â ›«ò Ê— Œ—Ìœ';//@type_kh_az_anbar nvarchar(100),
   ...
   datam_sp_eslahe_forosh.ADOStoredProc_eslahe_kharid_ezafe_jens.Parameters[25].Value:='„Õ’Ê· œ— «‰»«— „Ã«“Ì ﬁ—«— œ«—œ';//@tozihe_anbare_majazi nvarchar(200),
   ...
   if type_exist=2 then
     MessageBox(Handle,'»«  ÊÃÂ »Â „‘Œ’«  Ê«—œ ‘œÂ »—«Ì „Õ’Ê·° „Õ’Ê· Ìò »«— »Â ›«ò Ê— Œ—Ìœ Ê«—œ ‘œÂ «”  . ⁄œ«œ Ê«—œ ‘œÂ „Õ’Ê· »Â  ⁄œ«œ ﬁ»·Ì «÷«›Â ‘œ.','???',MB_OK or MB_ICONINFORMATION or MB_RIGHT or MB_RTLREADING);

   MessageBox(Handle,pchar('„Õ’Ê· «‰ Œ«»Ì »Â ‘„«—Â ›«ò Ê— «÷«›Â ‘œ.'),' ÊÃÂ!',MB_OK or MB_ICONINFORMATION or MB_RIGHT or MB_RTLREADING);
...
begin /////// exsits jens
  if MessageBox(Handle,'»«  ÊÃÂ »Â „‘Œ’«  Ê«—œ ‘œÂ »—«Ì „Õ’Ê·° „Õ’Ê· Ìò »«— »Â ›«ò Ê— Œ—Ìœ Ê«—œ ‘œÂ «”  . ⁄œ«œ Ê«—œ ‘œÂ „Õ’Ê· »Â  ⁄œ«œ ﬁ»·Ì «÷«›Â ê—œœø','???',MB_YESNO or MB_ICONQUESTION or MB_RIGHT or MB_RTLREADING)=id_yes then
  begin
...
begin
  ...
  if DataM_final.ADOQuery_pish_kharid.RecordCount >50 then
          MessageBox(Handle,' œ— Â— »«—Œ—Ìœ  Õœ «òÀ—  Å‰Ã«Â ( 50 ) ﬁ·„ „Õ’Ê· ﬁ«»· Œ—Ìœ „Ì»«‘œ .',' ÊÃÂ !',MB_OK or MB_ICONEXCLAMATION or MB_RIGHT or MB_RTLREADING)
  else
  begin
...
begin
  ...
  begin
   MessageBox(Handle,'»Â œ·Ì· «⁄„«· ò—«ÌÂ Ê ”Êœ »— —ÊÌ ›«ò Ê—° ÊÌ—«Ì‘ „‘Œ’«  „Õ’Ê· «„ò«‰Å–Ì— ‰„Ì »«‘œ. ',' ÊÃÂ !',MB_OK or MB_ICONEXCLAMATION or MB_RIGHT or MB_RTLREADING);
   Exit;
  end;}

  if DataM_final.ADOQuery_pish_kharidgeymat_jadid.AsFloat<>DataM_final.ADOQuery_pish_kharidgheymat.AsFloat then
  begin
   MessageBox(Handle,'»Â œ·Ì· «⁄„«· ò—«ÌÂ Ê ”Êœ »— —ÊÌ ›«ò Ê—° ÊÌ—«Ì‘ „‘Œ’«  „Õ’Ê· «„ò«‰Å–Ì— ‰„Ì »«‘œ. ò—«ÌÂ Ì« ”Êœ À»  ‘œÂ —« ’›— ò—œÂ° ”Å” „Õ’Ê· —« ÊÌ—«Ì‘ ‰„«ÌÌœ ',' ÊÃÂ !',MB_OK or MB_ICONEXCLAMATION or MB_RIGHT or MB_RTLREADING);
   Exit;
  end;
