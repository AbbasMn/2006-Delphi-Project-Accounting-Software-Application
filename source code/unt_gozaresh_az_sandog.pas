...
begin
 ...
 ' where sandog='+QuotedStr(s)+' and type='+QuotedStr('Ê—ÊœÌ');
 ...
 ' where sandog='+QuotedStr(s)+' and type='+QuotedStr('Œ—ÊÃÌ');
...
begin
    Label_type.Caption:='ê“«—‘ «“ ’‰œÊﬁ '+DBText1.Caption+' '+'œ— Â„Â ”«·Â«';
 {vorod-khoroj}
 ...
 DataModule_gozaresh_tarkibi.ADOQuery_jame_vorod_sandog.SQL.Text:='select sum(mablag) as vorod from T_vorod_khoroj_sandogha'+
 ' where sandog='+QuotedStr(DBText1.Caption)+' and type='+QuotedStr('Ê—ÊœÌ');
 DataModule_gozaresh_tarkibi.ADOQuery_jame_vorod_sandog.Open;

 DataModule_gozaresh_tarkibi.ADOQuery_kh_sandog.SQL.Text:='select sum(mablag) as khoroj from T_vorod_khoroj_sandogha'+
 ' where sandog='+QuotedStr(DBText1.Caption)+' and type='+QuotedStr('Œ—ÊÃÌ');
 DataModule_gozaresh_tarkibi.ADOQuery_kh_sandog.Open;

 frm_print_gozaresh_az_sandogh.QRL_type.Caption:=DBText1.Caption+' '+' »— «”«” Â„Â ”«·Â«';
...
begin
  Label_type.Caption:='ê“«—‘ «“ ’‰œÊﬁ '+DBText1.Caption+' '+'œ— ”«·  '+scsal.Text;
 {vorod-khoroj}
 DataModule_gozaresh_tarkibi.ADOQuery_daryaft_be_sandog.SQL.Text:='select * from T_vorod_khoroj_sandogha where sandog='+
 ...
 DataModule_gozaresh_tarkibi.ADOQuery_jame_vorod_sandog.SQL.Text:='select sum(mablag) as vorod from T_vorod_khoroj_sandogha'+
 ' where sandog='+QuotedStr(DBText1.Caption)+' and type='+QuotedStr('Ê—ÊœÌ')+' and tarikh like'+QuotedStr(scsal.Text+'%');
 DataModule_gozaresh_tarkibi.ADOQuery_jame_vorod_sandog.Open;

 DataModule_gozaresh_tarkibi.ADOQuery_kh_sandog.SQL.Text:='select sum(mablag) as khoroj from T_vorod_khoroj_sandogha'+
 ' where sandog='+QuotedStr(DBText1.Caption)+' and type='+QuotedStr('Œ—ÊÃÌ')+' and tarikh like'+QuotedStr(scsal.Text+'%');
 DataModule_gozaresh_tarkibi.ADOQuery_kh_sandog.Open;
...
begin
  Label_type.Caption:='ê“«—‘ «“ ’‰œÊﬁ '+DBText1.Caption+' '+' œ— ”«·  '+scsal2.Text+' „«Â '+scmah.Text;
 {vorod-khoroj}
  DataModule_gozaresh_tarkibi.ADOQuery_daryaft_be_sandog.SQL.Text:='select * from T_vorod_khoroj_sandogha where sandog='+
  ...
  DataModule_gozaresh_tarkibi.ADOQuery_jame_vorod_sandog.SQL.Text:='select sum(mablag) as vorod from T_vorod_khoroj_sandogha'+
  ' where  sandog='+QuotedStr(DBText1.Caption)+' and type='+QuotedStr('Ê—ÊœÌ')+' and tarikh like'+QuotedStr(scsal2.Text+'/'+frm_search.getmonth(scmah.Text)+'%');
  DataModule_gozaresh_tarkibi.ADOQuery_jame_vorod_sandog.Open;

  DataModule_gozaresh_tarkibi.ADOQuery_kh_sandog.SQL.Text:='select sum(mablag) as khoroj from T_vorod_khoroj_sandogha'+
 ' where sandog='+QuotedStr(DBText1.Caption)+' and type='+QuotedStr('Œ—ÊÃÌ')+' and tarikh like'+QuotedStr(scsal2.Text+'/'+frm_search.getmonth(scmah.Text)+'%');
 DataModule_gozaresh_tarkibi.ADOQuery_kh_sandog.Open;

 frm_print_gozaresh_az_sandogh.QRL_type.Caption:=DBText1.Caption+' '+' »— «”«” ”«· '+scsal2.Text+' „«Â '+scmah.Text;

 l_mojodi.Caption:=FloatToStr(DataModule_gozaresh_tarkibi.ADOQuery_jame_vorod_sandogvorod.AsFloat-DataModule_gozaresh_tarkibi.ADOQuery_kh_sandogkhoroj.AsFloat);
end;
procedure TFrm_gozaresh_az_sandog.show_sandog_tarikh;
begin
  Label_type.Caption:='ê“«—‘ «“ ’‰œÊﬁ '+DBText1.Caption+' '+'œ— ”«·  '+scsalall.Text+' „«Â '+scmahall.Text+' —Ê“ '+scrooz.Text;
 {vorod-khoroj}
  DataModule_gozaresh_tarkibi.ADOQuery_daryaft_be_sandog.SQL.Text:='select * from T_vorod_khoroj_sandogha where sandog='+
  ...
  DataModule_gozaresh_tarkibi.ADOQuery_jame_vorod_sandog.SQL.Text:='select sum(mablag) as vorod from T_vorod_khoroj_sandogha'+
  ' where sandog='+QuotedStr(DBText1.Caption)+' and type='+QuotedStr('Ê—ÊœÌ')+' and tarikh='+QuotedStr(scsalall.Text+'/'+frm_search.getmonth(scmahall.Text)+'/'+scrooz.Text);
  DataModule_gozaresh_tarkibi.ADOQuery_jame_vorod_sandog.Open;

  frm_print_gozaresh_az_sandogh.QRL_type.Caption:=DBText1.Caption+' '+' »— «”«”  «—ÌŒ'+scrooz.Text+'/'+scmahall.Text+'/'+scsalall.Text;

  DataModule_gozaresh_tarkibi.ADOQuery_kh_sandog.Close;

   DataModule_gozaresh_tarkibi.ADOQuery_kh_sandog.SQL.Text:='select sum(mablag) as khoroj from T_vorod_khoroj_sandogha'+
 ' where sandog='+QuotedStr(DBText1.Caption)+' and type='+QuotedStr('Œ—ÊÃÌ')+' and tarikh='+QuotedStr(scsalall.Text+'/'+frm_search.getmonth(scmahall.Text)+'/'+scrooz.Text);
 DataModule_gozaresh_tarkibi.ADOQuery_kh_sandog.Open;
