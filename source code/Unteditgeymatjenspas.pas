...
type
  Tfrm_editgeymatjens = class(TForm)
    ...
    b_eslahe_geymate_forosh_koli: TButton;
    ...
    procedure b_eslahe_geymate_forosh_koliClick(Sender: TObject);
  private
...
procedure Tfrm_editgeymatjens.b_eslahe_geymate_foroshClick(Sender: TObject);
begin
...
procedure Tfrm_editgeymatjens.b_eslahe_geymate_forosh_koliClick(
  Sender: TObject);
begin
if Dmanbar.ADOeditgeymat.RecordCount>0 then
begin
