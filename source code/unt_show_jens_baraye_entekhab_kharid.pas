...
uses Untdmanbarexit, Untviewanbar, unt_add_jens_to_pishkharid,
  unt_vorode_jense_motefarege, Unt_sefaresh_jadid, unt_anjirestan_jamavari;
...
begin
if frm_anjirestan_jamavari<>nil then
begin
   frm_anjirestan_jamavari.l_jans_name.Caption:=Dmanbarexite.ADOanbarcalacalaname.AsString;
   frm_anjirestan_jamavari.L_barcod.Caption:=Dmanbarexite.ADOanbarcalabarcod.AsString;
   frm_anjirestan_jamavari.e_code_sherkati.Text:=Dmanbarexite.ADOanbarcalacode_sherkati.AsString;

   if Dmanbarexite.ADOanbarcalatedad_jozi_da_koli.AsFloat<>0 then
   begin
    frm_anjirestan_jamavari.l_vahed_koli.Caption:=Dmanbarexite.ADOanbarcalavahed_koli.AsString;
   frm_anjirestan_jamavari.L_vahed_jozi.Caption:=Dmanbarexite.ADOanbarcalavahed_jozi.AsString;
    frm_anjirestan_jamavari.l_tedad_J_dar_k.Caption:=Dmanbarexite.ADOanbarcalatedad_jozi_da_koli.AsString;
    frm_anjirestan_jamavari.RadioGroup_vahed_type.ItemIndex:=0;
    frm_anjirestan_jamavari.RadioGroup_vahed_type.Enabled:=false;
   end
   else
   begin
    frm_anjirestan_jamavari.l_vahed_koli.Caption:='';
    frm_anjirestan_jamavari.L_vahed_joji_jozi.Caption:=Dmanbarexite.ADOanbarcalavahed_jozi.AsString;
    frm_anjirestan_jamavari.l_tedad_J_dar_k.Caption:='';
    frm_anjirestan_jamavari.RadioGroup_vahed_type.ItemIndex:=1;
    frm_anjirestan_jamavari.RadioGroup_vahed_type.Enabled:=false;
   end;
end;
