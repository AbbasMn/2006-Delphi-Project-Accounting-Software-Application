...
begin
    ...
    frm_add_bank1.sharh:=' Å—œ«Œ  çò »—«Ì Œ—Ìœ ‘„«—Â '+DataM_final.ADOQ_T_pardakht_check_kharidshomare_factor.AsString+' «“ '+DataM_final.ADOQ_T_pardakht_check_kharidshahrforoshande.AsString;
    ...
    QuotedStr('»·Ì')+' where id='+l_id.Caption+' commit tran';
    ...
    MessageBox(Handle,pchar('çò Å—œ«Œ  ‘œÂ  Ê”ÿ ‘„« Å«” ê—œÌœ Ê »⁄‰Ê«‰ „Ê—œ »«‰òÌ –ŒÌ—Â ‘œ'),' ÊÃÂ! ',MB_OK or MB_ICONINFORMATION or MB_RTLREADING or MB_RIGHT );
end;
...
begin
  ...
  Frm_print_check_pardakhti.QRLtype.Caption:='·Ì”  Â„Â çòÂ«Ì Å—œ«Œ Ì ‘„«';
...
begin
  ...
  DataM_final.ADOQ_T_jame_pardakht_check_kharid.Open;
   ...
   Frm_print_check_pardakhti.QRLtype.Caption:=' ·Ì”  çòÂ«Ì Å—œ«Œ Ì ‘„« «“ »«‰ò '+s;
end;
...
Frm_print_check_pardakhti.QRLtype.Caption:=' ·Ì”  çòÂ«Ì Å—œ«Œ Ì ‘„« »« ‘„«—Â '+s;
end;
...
begin
 ...
 Frm_print_check_pardakhti.QRLtype.Caption:='·Ì”  çòÂ«Ì Å—œ«Œ Ì ‘„« òÂ „Ê⁄œ ¬‰Â« '+s+' „Ì»«‘œ.';
end;
...
begin
  show_bank(dbanbar.Text);
  Frm_print_check_pardakhti.QRLtype.Caption:='·Ì”  çòÂ«Ì Å—œ«Œ Ì ‘„« «“ œ” Â çòÂ«Ì „—»Êÿ »Â »«‰ò ' +dbanbar.Text;
end;
...
begin
  if DataM_final.ADOQ_T_pardakht_check_kharidpass.AsString='»·Ì' then
  begin
    MessageBox(Handle,'çò «‰ Œ«»Ì ﬁ»·« Å«” ‘œÂ Ê »⁄‰Ê«‰ „Ê—œ »«‰òÌ À»  ê—œÌœÂ «” ','Œÿ« !',MB_OK or MB_ICONEXCLAMATION or MB_RIGHT or MB_RTLREADING);    
    exit;
  end;

  if DataM_final.ADOQ_T_pardakht_check_kharidmablagh_check.AsFloat>mojodi_heasb then
  begin
    MessageBox(Handle,pchar(' „»·€ çò° «“ „ÊÃÊœÌ ‘„«—Â Õ”«» çò '+FloatToStr(mojodi_heasb)+' »Ì‘ — „Ì »«‘œ. '),'Œÿ«! ',MB_OK or MB_ICONEXCLAMATION or MB_RTLREADING or MB_RIGHT );
    exit;
  end;
