...
begin
    ...
    begin
      MessageBox(Handle,'‰«„ ò«—»—(«” ›«œÂ ò‰‰œÂ «“ ‰—„ «›“«—) —« Ê«—œ ‰„«ÌÌœ','Œÿ« !',MB_OK or MB_ICONEXCLAMATION or MB_RTLREADING or MB_RIGHT);
      exit;
    end;
    ...
    begin
      MessageBox(Handle,'‰«„ ò«—»— ﬁ»·« Ê«—œ ‘œÂ «” .','Œÿ«!',MB_OK or MB_ICONWARNING or MB_RIGHT or MB_RTLREADING);
      Exit;
    end;
    ...
    if (Dmlistha.ADOlogin2.RecordCount>0) then
    begin
      MessageBox(Handle,'‰«„ ò«—»—Ì ﬁ»·« Ê«—œ ‘œÂ «” .','Œÿ«!',MB_OK or MB_ICONWARNING or MB_RIGHT or MB_RTLREADING);
      Exit;
    end;
    ...
    begin
      ...
      MessageBox(Handle,'ò«—»— ÃœÌœ –ŒÌ—Â ê—œÌœ.',' ÊÃÂ!',MB_OK or MB_ICONINFORMATION or MB_RIGHT or MB_RTLREADING);
    end;
    ...
    begin
      ...
      begin
          ...
          begin
            MessageBox(Handle,'‰«„ ò«—»—Ì admin €Ì—ﬁ«»·  €ÌÌ— „Ì »«‘œ','Œÿ«!',MB_OK or MB_ICONWARNING or MB_RIGHT or MB_RTLREADING);
            exit;
          end;
        ...
        MessageBox(Handle,'ò«—»— «‰ Œ«»Ì «’·«Õ ê—œÌœ.',' ÊÃÂ!',MB_OK or MB_ICONINFORMATION or MB_RIGHT or MB_RTLREADING);
      end;
    end;
...
begin
  if(Dmlistha.ADOloginusername.AsString='admin') then
    MessageBox(Handle,'ò«—»— admin ﬁ«»· Õ–› ‰„Ì »«‘œ','Œÿ«!',MB_OK or MB_ICONWARNING or MB_RIGHT or MB_RTLREADING)
  else
  begin
      if Dmlistha.ADOlogin.RecordCount>0 then
      begin
...
begin
      ...
      begin
          if(Dmlistha.ADOloginusername.AsString='admin') then
          begin
            MessageBox(Handle,'ò«—»— admin »Â Â„Â ”ÿÊÕ ‰—„ «›“«— œ” —”Ì œ«—œ.','Œÿ«!',MB_OK or MB_ICONWARNING or MB_RIGHT or MB_RTLREADING);
            exit;
          end;
