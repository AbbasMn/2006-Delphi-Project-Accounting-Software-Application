unit unt_add_jens_to_pishkharid;
...
type
  TFrm_add_jens_to_pishkharid = class(TForm)
...
var
  Frm_add_jens_to_pishkharid: TFrm_add_jens_to_pishkharid;
...
function TFrm_add_jens_to_pishkharid.check(s:string):boolean;
var i,j:integer;
begin
    check:=true;
    j:=0;
...
///////////
procedure TFrm_add_jens_to_pishkharid.clear;
begin
...
function TFrm_add_jens_to_pishkharid.check_param:boolean;
var s:pchar;
     st:string;
begin
...
procedure TFrm_add_jens_to_pishkharid.get_public_parametr;
var t,temp2:string;
    temp:real;
begin
  if RadioGroup_jens_type.ItemIndex=0 then
...
procedure TFrm_add_jens_to_pishkharid.show_vahed;
begin
 Dmlistha.ADOQuery_vahed.SQL.Text:='select * from t_vahed order by vahed';
 Dmlistha.ADOQuery_vahed.Open;
end;
procedure TFrm_add_jens_to_pishkharid.vahed_type;
begin
  if RadioGroup_vahed_type.ItemIndex=0 then
  begin
...
procedure TFrm_add_jens_to_pishkharid.jens_type;
begin
   if RadioGroup_jens_type.ItemIndex=0 then
   begin
...
procedure TFrm_add_jens_to_pishkharid.geymat_kol;
var p:pchar;
     x:real;
begin
...
function TFrm_add_jens_to_pishkharid.return1:boolean;
  begin
    return1:=false;
...
procedure TFrm_add_jens_to_pishkharid.suiButton2Click(Sender: TObject);
begin
  clear;
  //return1;
  close;
...
procedure TFrm_add_jens_to_pishkharid.FormShow(Sender: TObject);
begin
...
procedure TFrm_add_jens_to_pishkharid.RadioGroup_jens_typeClick(
  Sender: TObject);
begin
  jens_type;
end;

procedure TFrm_add_jens_to_pishkharid.RadioGroup_vahed_typeClick(
  Sender: TObject);
begin
  vahed_type;
end;

procedure TFrm_add_jens_to_pishkharid.suiButton3Click(Sender: TObject);
...
procedure TFrm_add_jens_to_pishkharid.FormClose(Sender: TObject;
...
procedure TFrm_add_jens_to_pishkharid.Edit1Change(Sender: TObject);
begin
  l_jans_name.Caption:=Edit1.Text;
end;

procedure TFrm_add_jens_to_pishkharid.Edit1Exit(Sender: TObject);
begin
  l_jans_name.Caption:=Edit1.Text;
end;

procedure TFrm_add_jens_to_pishkharid.Button1Click(Sender: TObject);
begin
  frm_show_jens_baraye_entekhab_kharid.ShowModal;
end;

procedure TFrm_add_jens_to_pishkharid.E_barcodChange(Sender: TObject);
begin
  L_barcod.Caption:=E_barcod.Text;
end;

procedure TFrm_add_jens_to_pishkharid.E_barcodExit(Sender: TObject);
begin
  L_barcod.Caption:=E_barcod.Text;
end;

procedure TFrm_add_jens_to_pishkharid.Edit2KeyPress(Sender: TObject;
  var Key: Char);
begin
...
procedure TFrm_add_jens_to_pishkharid.Edit_tedad_vahed_koliKeyPress(
...
procedure TFrm_add_jens_to_pishkharid.Edit_tedad_jozei_dar_koliKeyPress(
  Sender: TObject; var Key: Char);
begin
if not (key in['0'..'9',#8]) then
   key:=#0;
...
procedure TFrm_add_jens_to_pishkharid.Edit_g_vahed_koliKeyPress(
  Sender: TObject; var Key: Char);
begin
   if not (key in['0'..'9',#8]) then
   key:=#0;
...
procedure TFrm_add_jens_to_pishkharid.Edit3KeyPress(Sender: TObject;
  var Key: Char);
begin
   if not (key in['0'..'9',#8]) then
   key:=#0;
...
procedure TFrm_add_jens_to_pishkharid.e_code_sherkatiChange(
  Sender: TObject);
begin
  e_code_sherkati.Text:=UpperCase(e_code_sherkati.Text);
end;

procedure TFrm_add_jens_to_pishkharid.Edit2Change(Sender: TObject);
begin
...
procedure TFrm_add_jens_to_pishkharid.Edit_tedad_vahed_koliChange(
  Sender: TObject);
begin
