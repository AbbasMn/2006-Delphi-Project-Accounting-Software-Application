...
begin
  ...
  frm_print_bank.QRL_type.Caption:=' »—«”«”  «—ÌŒ '+' «“ '+begin_+' « '+ end_;
...
begin
  ...
  frm_print_bank2.QRL_type.Caption:=' »—«”«” Õ”«» Ã«—Ì  '+Dmlistha.ADOQuery_shomare_hesabe_bankibank_shobe_sh_hesab.AsString+
  ' «“ '+begin_+' « '+ end_;
end;
 ...
 begin
   if RadioGroup1.ItemIndex=0 then
    ...
    begin
      ...
      G_do_tarikh.Visible:=False;
      tarikh;
      frm_print_bank.QRL_type.Caption:='»—«”«”  «—ÌŒ   '+E_tarikh.Text;
    end;
